...
import { ReadonlyEditor } from '@dyn/arb-svg-editor';
import { prepareDtif, type ARB } from '@dyn/figma-to-dtif';
...
export const ArtboardPreview: React.FC<TProps> = (props) => {
	const { isTransforming } = props;

	const [dtif, setDtif] = React.useState<ARB.DtifArtboard | null>(null);
	const [preparedDtif, setPreparedDtif] = React.useState<ARB.DtifArtboard | null>(null);

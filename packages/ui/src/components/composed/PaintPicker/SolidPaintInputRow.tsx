...
export const SolidPaintInputRow = React.forwardRef<React.ElementRef<typeof PopoverTrigger>, TProps>(
	(props, forwardedRef) => {
		const { paint, onPaintUpdate, ...popoverTrigger } = props;
...
SolidPaintInputRow.displayName = 'SolidPaintInputRow';

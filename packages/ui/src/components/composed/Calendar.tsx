 ...
 * Project Repository: https://github.com/shadcn-ui/ui/blob/main/apps/www/registry/new-york/ui/calendar.tsx
 *
...
const Calendar: React.FC<CalendarProps> = ({
	...
	return (
		<DayPicker
			...
			components={{
				// eslint-disable-next-line react/no-unstable-nested-components -- Ok here

...
use dyn_cnv_bundles::components::mixins::SizeMixin;
...
pub fn extract_changed_components(
    ...
    for (entity, cnvopnent_variants) in watched_entities_res.get_watched_entities().iter() {
        for component_variant in cnvopnent_variants {

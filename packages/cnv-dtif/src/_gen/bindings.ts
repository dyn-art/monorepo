...
export type CanvasChangeOutputEvent = { viewport: Viewport; size: Size }

export type CnvVersion = "V000001"
...
export type CursorDownOnCnvInputEvent = { position: Vec2; button: MouseButton }
...
export type CursorEnteredCnvInputEvent = null

export type CursorExitedCnvInputEvent = null

export type CursorMovedOnCnvInputEvent = { position: Vec2 }

export type CursorUpOnCnvInputEvent = { position: Vec2; button: MouseButton }
 ...
 */
export type DtifCanvas = { version?: CnvVersion | null; 
/**
...
export type InteractionInputEvent = ({ type: "KeyDownOnCanvas" } & KeyDownOnCnvInputEvent) | ({ type: "KeyUpOnCanvas" } & KeyUpOnCnvInputEvent) | ({ type: "CursorEnteredCanvas" }) | ({ type: "CursorExitedCanvas" }) | ({ type: "CursorMovedOnCanvas" } & CursorMovedOnCnvInputEvent) | ({ type: "CursorDownOnCanvas" } & CursorDownOnCnvInputEvent) | ({ type: "CursorUpOnCanvas" } & CursorUpOnCnvInputEvent) | ({ type: "MouseWheeledOnCanvas" } & MouseWheeledOnCnvInputEvent) | ({ type: "CursorDownOnEntity" } & CursorDownOnEntityInputEvent) | ({ type: "CursorDownOnResizeHandle" } & CursorDownOnResizeHandleInputEvent) | ({ type: "CursorDownOnRotateHandle" } & CursorDownOnRotateHandleInputEvent) | ({ type: "InteractionToolChanged" } & InteractionToolChangedInputEvent)
...
export type KeyDownOnCnvInputEvent = { 
/**
 * The physical key code of the key.
 */
keyCode: KeyCode }

export type KeyUpOnCnvInputEvent = { 
/**
 * The physical key code of the key.
 */
keyCode: KeyCode }
...
export type MouseWheeledOnCnvInputEvent = { position: Vec2; delta: Vec2 }
...
export type SpectaExport = { cnv_dtif: DtifCanvas; svg_cnv_input_event: SvgCnvInputEvent; svg_cnv_output_event: SvgCnvOutputEvent }
...
export type SvgCnvInputEvent = { type: "Core"; event: CoreInputEvent } | { type: "Interaction"; event: InteractionInputEvent }

export type SvgCnvOutputEvent = ({ type: "SvgElementChange" } & SvgElementChangesOutputEvent) | ({ type: "CanvasChange" } & CanvasChangeOutputEvent) | ({ type: "WatchedEntityChange" } & WatchedEntityChangesOutputEvent) | ({ type: "SelectionChange" } & SelectionChangeOutputEvent) | ({ type: "InteractionModeChange" } & InteractionModeChangeOutputEvent) | ({ type: "InteractionToolChange" } & InteractionToolChangeOutputEvent) | ({ type: "CursorChange" } & CursorChangeOutputEvent)
...
export type UpdateCanvasSizeInputEvent = { size: Size }

export type UpdateCanvasViewportInputEvent = { viewport: Viewport }

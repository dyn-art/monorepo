...
export interface components {
    schemas: {
        ...
        CoreInputEvent: ({
            type: "CoreInputEvent";
        } & (components["schemas"]["UpdateArtboardSizeInputEvent"] & {
            /** @enum {string} */
        ...
        LayoutElement: ({
            type: "LayoutElement";
        } & (components["schemas"]["AbsoluteLayoutElement"] & {
            /** @enum {string} */
            type: "Absolute";
        })) | ({
            type: "LayoutElement";
        ...
        TextAttributes: {
            ...
            letterSpacing?: Omit<components["schemas"]["FontUnit"], "type"> | null;
            lineHeight?: Omit<components["schemas"]["FontUnit"], "type"> | null;
            smallCaps?: boolean | null;
            wordSpacing?: Omit<components["schemas"]["FontUnit"], "type"> | null;
        };
        TextNode: {
        ...
        UpdateFillStyleInputEvent: {
            id: components["schemas"]["ReferenceIdOrEntity"];
            paintId?: Omit<components["schemas"]["ReferenceIdOrEntity"], "type"> | null;
        };
        ...
        UpdateGradientPaintInputEvent: {
            ...
            variant?: Omit<components["schemas"]["GradientVariant"], "type"> | null;
        };
        UpdateImagePaintInputEvent: {
            id: components["schemas"]["ReferenceIdOrEntity"];
            imageId?: components["schemas"]["ImageId"] | null;
            scaleMode?: Omit<components["schemas"]["ImageScaleMode"], "type"> | null;
        };
    ...
    post_v1_arb_render_handler: {
        parameters: {
            ...
            path: {
                ...
                scriptArgs: {
                    [key: string]: components["schemas"]["LuaScriptArgsMap"] | undefined;
                } | null;
            };
            cookie?: never;
        };

...
use dyn_cnv_asset::asset_id::ImageId;
use dyn_utils::{
...
pub enum CoreInputEvent {
    // Canvas
    UpdateCanvasSize(UpdateCanvasSizeInputEvent),
    UpdateCanvasViewport(UpdateCanvasViewportInputEvent),
...
impl InputEvent for CoreInputEvent {
    fn register_events(app: &mut App) {
        // Canvas
        app.add_event::<UpdateCanvasSizeInputEvent>();
        app.add_event::<UpdateCanvasViewportInputEvent>();
    ...
    fn send_into_world(self, world: &mut World) {
        match self {
            // Canvas
            CoreInputEvent::UpdateCanvasSize(event) => {
                world.send_event(event);
            }
            CoreInputEvent::UpdateCanvasViewport(event) => {
                world.send_event(event);
            }
...
#[cfg_attr(feature = "utoipa_support", derive(utoipa::ToSchema))]
pub struct UpdateCanvasSizeInputEvent {
    pub size: Size,
}
...
#[cfg_attr(feature = "utoipa_support", derive(utoipa::ToSchema))]
pub struct UpdateCanvasViewportInputEvent {

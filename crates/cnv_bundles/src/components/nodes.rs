...
pub struct CnvNode {
    pub variant: CnvNodeVariant,
}

#[derive(Debug, Copy, Clone)]
pub enum CnvNodeVariant {
    Rectangle,
    Frame,
    Ellipse,
    Polygon,
...
#[derive(Component, Debug, Copy, Clone)]
pub struct PolygonCnvNode {
    /// The number of polygon sides, minimum 3.
    pub point_count: u8,
}

impl Default for PolygonCnvNode {
    fn default() -> Self {
        Self { point_count: 3 }
    }
}

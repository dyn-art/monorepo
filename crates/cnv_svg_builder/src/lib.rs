...
pub struct CnvSvgBuilderPlugin {
...
impl Plugin for CnvSvgBuilderPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.configure_sets(
            PostUpdate,
            (
                CnvSvgBuilderSystemSet::Prepare,
                CnvSvgBuilderSystemSet::PreApply,
                CnvSvgBuilderSystemSet::Apply,
                CnvSvgBuilderSystemSet::Extract,
                CnvSvgBuilderSystemSet::Queue,
            )
                .chain(),
        );
        ...
        app.add_systems(
            PostUpdate,
            (
                propagate_size_mixin_to_style.in_set(CnvSvgBuilderSystemSet::Prepare),
                insert_node_svg_bundle.in_set(CnvSvgBuilderSystemSet::Prepare),
                insert_style_svg_bundle
                    .in_set(CnvSvgBuilderSystemSet::Prepare)
                    .after(insert_node_svg_bundle),
                apply_node_children_changes.in_set(CnvSvgBuilderSystemSet::PreApply),
                apply_node_styles_changes
                    .in_set(CnvSvgBuilderSystemSet::PreApply)
                    .after(apply_node_children_changes),
                apply_visibility_mixin_changes.in_set(CnvSvgBuilderSystemSet::Apply),
                apply_size_mixin_changes.in_set(CnvSvgBuilderSystemSet::Apply),
                apply_transform_changes.in_set(CnvSvgBuilderSystemSet::Apply),
                apply_opacity_mixin_changes.in_set(CnvSvgBuilderSystemSet::Apply),
                apply_blend_mode_mixin_changes.in_set(CnvSvgBuilderSystemSet::Apply),
                apply_clip_content_changes.in_set(CnvSvgBuilderSystemSet::Apply),
                apply_path_mixin_changes.in_set(CnvSvgBuilderSystemSet::Apply),
                apply_stroke_path_mixin_changes.in_set(CnvSvgBuilderSystemSet::Apply),
                apply_solid_paint_changes.in_set(CnvSvgBuilderSystemSet::Apply),
                apply_gradient_paint_changes.in_set(CnvSvgBuilderSystemSet::Apply),
                apply_image_paint_changes.in_set(CnvSvgBuilderSystemSet::Apply),
                apply_image_asset_mixin_changes.in_set(CnvSvgBuilderSystemSet::Apply),
                apply_drop_shadow_changes.in_set(CnvSvgBuilderSystemSet::Apply),
            ),
        );
        ...
        #[cfg(feature = "output_svg_element_changes")]
        {
            ...
            app.add_systems(
                PostUpdate,
                (
                    extract_node_bundles.in_set(CnvSvgBuilderSystemSet::Extract),
                    extract_style_bundles.in_set(CnvSvgBuilderSystemSet::Extract),
                    queue_svg_bundle_changes.in_set(CnvSvgBuilderSystemSet::Queue),
                ),
            );
        }
    }

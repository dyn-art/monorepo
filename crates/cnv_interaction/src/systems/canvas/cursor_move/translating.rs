use crate::{
    components::Selected, events::CursorMovedOnCnvInputEvent, utils::transform_point_to_viewport,
};
use bevy_ecs::{query::With, system::Query};
use bevy_hierarchy::Parent;
use bevy_transform::components::{GlobalTransform, Transform};
use dyn_cnv_bundles::utils::{get_parent_global_transfrom, global_to_local_vector3};
...
pub fn handle_translating(
    ...
    let offset = transform_point_to_viewport(cnv_res, &(*cursor_position - *current), false);

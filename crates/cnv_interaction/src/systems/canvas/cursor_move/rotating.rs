use crate::{
    components::Selected, events::CursorMovedOnCnvInputEvent,
    resources::cnv_interaction::HandleSide, utils::transform_point_to_viewport,
};
use bevy_ecs::{query::With, system::Query};
use bevy_transform::components::{GlobalTransform, Transform};
use dyn_cnv_bundles::{components::mixins::SizeMixin, utils::transform_to_z_rotation_rad};
...
pub fn handle_rotating(
    ...
    let cursor_position = transform_point_to_viewport(cnv_res, cursor_position, true);

...
pub fn stroke_path_system(
    ...
    stroke_query: Query<
        (Entity, &StrokeCnvStyle, Option<&StyleParentMixin>),
        Changed<StrokeCnvStyle>,
    >,
    path_query: Query<(&PathMixin, Option<&StyleChildrenMixin>), Changed<PathMixin>>,
    stroke_style_query: Query<&StrokeCnvStyle>,
) {

...
#[derive(Debug, Clone)]
pub struct SolidStrokeSvgBundle {
...
impl SvgBundle for SolidStrokeSvgBundle {
...
impl SolidStrokeSvgBundle {
    pub fn new(entity: Entity, cx: &mut SvgContextRes) -> Self {
        log::info!("[SolidStrokeSvgBundle::new] {:?}", entity);
    ...
    fn create_element_name(id: SvgElementId, category: &str) -> String {
        format!("solid-stroke_{}_{}", category, id)
    }
}
